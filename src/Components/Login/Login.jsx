...
console.log(Errors);
  return (
    <div>
      <span className="btn "style={{border:"1px solid #444"}} onClick={handleShow}>login</span>
...
<Modal show={show} onHide={handleClose}>
        {/* <Modal.Header closeButton>
            ...
            <div className="d-flex align-items-center justify-content-between mt-2  ">
               <span className='mx-2  span_Modal_Login fw-bold  mt-2 d-flex align-items-center justify-content-center' onClick={handleClose}>X</span>
