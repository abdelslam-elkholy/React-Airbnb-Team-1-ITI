...
import PaymentStyleInfo from '../Payment_Style_Info/PaymentStyleInfo'
...
const PaymentHome = () => {
 ...
 <div className="container-fluid">
  ...
  <path fillRule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0z"/>
          ...
          </Link> <span className="mx-2">Request to book</span></h1>
      </div>
        ...
        <div className="col-lg-6 col-md-6 col-sm-12 mx-4">
                ...
                <div className="d-flex align-items-center flex-column my-3 mx-auto border-bottom">
                   ...
                   <div className="d-flex align-items-center justify-content-between w-100 ">
                        ...
                        <div><a  className=' text-dark'>Edit</a></div>
                    </div>
                    <span>Sep 14 – 19</span>
                   </div>
         ...
         <div className=" d-flex align-items-center  justify-content-between w-100">
                        ...
                        <a  className='text-dark' onClick={() => setModalShow(true)}>Edit</a>
      ...
      <option value="googlepay">
        <Link to="/GooglePay">
          <FaGooglePay /> Google Pay
            ...
            <div className="col-lg-5 col-md-6 col-sm-12 fixed_form"><PaymentStyleInfo/> </div>
...
<span className='Close_btn'>
          ...
          style={{display: "block", fill: "none", height: "20px", width: "20px", stroke: "currentcolor", strokeWidth: 3, overflow: "visible"}}>
      ...
      <Modal.Footer className='d-flex align-items-center justify-content-between'>
        <button onClick={props.onHide} className='text-dark bg-white pointer ' style={{fontSize:"18px",border:"none "}}>< a className="text-dark "href=''>Cancle</a></button>
        <Button onClick={props.onHide} className='text-white bg-dark py-2 pointer px-4'>Save</Button>
      </Modal.Footer>
    </Modal>
  );
}
