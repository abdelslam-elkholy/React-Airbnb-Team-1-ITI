  ...
  return (
    <div>
      <div className="border-bottom my-2">
        <p className="my-2">Log in to use PayPal.</p>
<button className="btn  py-3 my-4" style={{width:"150px",backgroundColor:"#409bd8",borderRadius:"10px"}}>
  <a href="https://www.paypal.com/agreements/approve?nolegacy=1&ba_token=BA-63T159963P8507827">
  <img  style={{width:"85px"}}
   src="https://a0.muscache.com/airbnb/static/packages/assets/frontend/quick-pay/images/paypal.1b497231b38bd2a52b5d460a92a82fb7.svg" alt="" />
   ...
   By selecting the button below, I agree to the <a href="#" className="text-dark bold">Host's House Rules, Ground rules for guests, Airbnb's Rebooking and Refund Policy</a>, 
    and that Airbnb can
     <a href="" className="text-dark bold">charge my payment method</a> if I’m responsible for damage. </p>
      <div className="my-5">
   <button className="btn btn__payment py-3 px-3 text-white "style={{fontWeight:"bold"}}  >Request to book</button>
      </div>
      </div>
